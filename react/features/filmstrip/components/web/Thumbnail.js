...
import { GrantModeratorButton, SpotlightButton, MuteButton, MuteEveryoneElseButton, KickButton, RemoteVideoMenu } from '../../../remote-video-menu'
import RemoteVideoMenuTriggerButtons from '../../../remote-video-menu/components/web/RemoteVideoMenuTriggerButtons';
import PinVideoIndicator from './PinVideoIndicator';
...
class Thumbnail extends Component<Props, State> {
    ...
    _renderTopIndicators() {
        ...
        case LAYOUTS.TILE_VIEW:
            ...
            break;
        case LAYOUTS.VERTICAL_FILMSTRIP_VIEW:
            statsPopoverPosition = 'right bottom';
    ...
    _renderRemoteVideoMenu() {
        ...
        const buttons = [];
            ...
            buttons.push(
              <SpotlightButton key="Spotlight" participantID={participantID} />
            );
